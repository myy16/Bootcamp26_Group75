...
def general_chat_node(state: AgentState):
    ...
    try:
        system_prompt = (
            "Sen Beautrics akıllı güzellik ve kozmetik danışmanısın. "
            "Kullanıcıya son derece samimi, nazik ve yardımsever bir dille cevap ver.\n"
            "KURALLAR:\n"
            "- Teşekkür veya selamlama mesajlarına içtenlikle karşılık ver.\n"

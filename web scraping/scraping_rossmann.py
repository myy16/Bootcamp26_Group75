                    ...
                    if tam_isim not in cekilen_isimler:
                        ...
                        try:
                            ...
                            try:
                                ...
                                pass
                        temiz_fiyat = fiyat.replace("TL", "").replace("₺", "").replace(".", "").replace(",",
                                                                                                        ".").strip()

                        # --- STOK DURUMU KONTROLÜ ---
                        # Rossmann'da tükenen ürünlerde "Tükendi" / "Stokta Yok" etiketi
                        # veya "Sepete Ekle" butonu yerine farklı bir buton/metin çıkar.
                        try:
